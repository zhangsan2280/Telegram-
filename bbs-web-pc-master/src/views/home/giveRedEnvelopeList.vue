                ...
                <el-table :data="state.pageView.records" stripe class="dataTable">
                    ...
                    <el-table-column align="center" width="200">
                        ...
                        <template #default="scope">
                            ...
                            <span v-if="scope.row.refundAmount >0" class="refundAmount">中止领取红包后返还金额￥{{scope.row.refundAmount}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column prop="giveQuantity" label="发放数量" width="100" align="center"/>
                    ...
                    <el-table-column prop="giveTime" label="时间"  width="170" align="center"/>
                    <el-table-column width="150" align="center">
                        ...
                        <template #default="scope">
                            <el-button-group>
                                <el-button type="primary" @click="router.push({path: '/user/control/redEnvelopeAmountDistributionList', query:{ giveRedEnvelopeId : scope.row.id}})" >查看金额分配</el-button>
...
<script lang="ts" setup>
    ...
    const { meta } = useMeta(
        computed(() => ({ 
            title:  '发红包列表 - ' + store.state.title,
            meta: [
                {
                    name: 'keywords',
                    content: '发红包列表 - ' + store.state.title
                },{
                    name: "description",
                    content: '发红包列表 - ' + store.state.title
                }
