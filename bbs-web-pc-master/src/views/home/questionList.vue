            ...
            <div class="questionListModule" >
                <el-table :data="state.pageView.records" stripe class="dataTable">
                    ...
                    <el-table-column width="130" align="center">
                        ...
                        <template #default="scope">
                            <el-button-group>
                                <el-button type="primary" @click="router.push({path: '/user/control/questionFavoriteList', query:{ questionId : scope.row.id,questionPage:state.currentpage}})"  >收藏用户</el-button>
                            </el-button-group>
                        </template>
                    </el-table-column>
...
<script lang="ts" setup>
    ...
    const { meta } = useMeta(
        computed(() => ({ 
            title:  '我的问题 - ' + store.state.title,
            meta: [
                {
                    name: 'keywords',
                    content: '我的问题 - ' + store.state.title
                },{
                    name: "description",
                    content: '我的问题 - ' + store.state.title
                }
